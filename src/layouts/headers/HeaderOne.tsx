						...
						<div className="cs_main_header_in">
							<div className="cs_main_header_left">
								<Link className="cs_site_branding logo-dark" href="/">
									<Image style={{height:"80px !important;", maxHeight:"none !important;"}} width={170} height={80} src={logo} alt="Logo" />
								</Link>
										...
										<a href="tel:0141 459 1081">
											<svg width="35" height="35" viewBox="0 0 18 19" fill="none"
												...
												<path
													...
													fill="white"></path>
											</svg><span className="ms-2">0141 459 1081</span></a>
									</h4>
{/* 
