...
const testimonial_data: DataType[] = [
  {
    ...
    name: `James Muir`,
    location: `Glasgow, UK`,
    des: `“VDF Electrical did a fantastic job rewiring our home. The team was punctual, professional, and made sure everything was safe and up to code. Highly recommend!”`,
  },
  {
    img: avatar_img,
    name: `Sandra Lewis`,
